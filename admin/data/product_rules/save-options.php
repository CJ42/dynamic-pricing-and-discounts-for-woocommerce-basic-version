...
if(isset($_GET['offer_name']) && !empty($_GET['offer_name']) && (($_GET['rule_on']=='products' &&  isset($_GET['product_id'])  && !empty($_GET['product_id'])) || ($_GET['rule_on']=='categories' &&  isset($_GET['category_id'])  && !empty($_GET['category_id'])) || ($_GET['rule_on']=='cart' ) )  && isset($_GET['check_on']) && !empty($_GET['check_on']) && isset($_GET['min']) && !empty($_GET['min']) && isset($_GET['discount_type']) && !empty($_GET['discount_type']) && isset($_GET['value']) && !empty($_GET['value']) && isset($_GET['submit']) && !isset($_GET['edit']) )
			{
					...
					if(!isset($prev_data[$active_tab]) || sizeof($prev_data[$active_tab])==0)
					{
                                                                                                            $prev_data[$active_tab][1]=array ( 'offer_name' => sanitize_text_field($_GET['offer_name']),
                                                                                                                            ...
                                                                                                                            'adjustment' => sanitize_text_field($_GET['adjustment']),
                                                                                                                            );
					}
					else
					{
