...
<table class="table"style="font-size: small;    margin: auto;" >
	...
	<tbody style="font-size: inherit;width: 100%;">
		<tr style="font-size: inherit;width: 100%;">
			...
			<td style="font-size: inherit;width:8%;max-width:100px;min-width:100px;">
			<select name="check_on" class="all-options" style="font-size: inherit;width: 100%;"  >
			<option value="Quantity"  style="font-size: inherit;" <?php if(!empty($_GET['check_on']) && $_GET['check_on'] =='Quantity')echo'Selected';  ?> ><?php esc_attr_e( 'No. of Items','eh-dynamic-pricing-discounts' ); ?></option>
			...
			<option value="Weight" style="font-size: inherit;" <?php if(!empty($_GET['check_on']) && $_GET['check_on'] =='Weight')echo'Selected';  ?>><?php esc_attr_e( 'Weight','eh-dynamic-pricing-discounts' ); ?></option>
			<option value="Price" style="font-size: inherit;" <?php if(!empty($_GET['check_on']) && $_GET['check_on'] =='Price')echo'Selected';  ?>><?php esc_attr_e( 'Price','eh-dynamic-pricing-discounts' ); ?></option>
			</select>
			</td>
			...
			<option value='Percent Discount' style="font-size: inherit;"   <?php if(!empty($_GET['discount_type']) && $_GET['discount_type'] =='Percent Discount') echo'Selected';  ?> ><?php esc_attr_e( 'Percent Discount','eh-dynamic-pricing-discounts' ); ?></option>
			<option value='Flat Discount' style="font-size: inherit;"   <?php if(!empty($_GET['discount_type']) && $_GET['discount_type'] =='Flat Discount') echo'Selected';  ?> ><?php esc_attr_e( 'Flat Discount','eh-dynamic-pricing-discounts' ); ?></option>
			<option value='Fixed Price' style="font-size: inherit;"   <?php if(!empty($_GET['discount_type']) && $_GET['discount_type'] =='Fixed Price') echo'Selected';  ?> ><?php esc_attr_e( 'Fixed Price','eh-dynamic-pricing-discounts' ); ?></option>
			</select>
			</td>
